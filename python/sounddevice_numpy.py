...
wave_1 = np.append(wave_1, gen_sweep(440, 880, 1.0))
wave_2 = np.append(wave_2, gen_mono(440, 1.0, phase))

wave_1 = np.append(wave_1, gen_mono(880, 3.0))
wave_2 = np.append(wave_2, gen_mono(440, 3.0, phase))

wave_1 = np.append(wave_1, gen_sweep(880, 440, 1.0))
wave_2 = np.append(wave_2, gen_mono(440, 1.0, phase))

wave_1 = np.append(wave_1, gen_mono(440, 3.0))
wave_2 = np.append(wave_2, gen_mono(440, 3.0, phase))
